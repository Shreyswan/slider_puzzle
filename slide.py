...
BOARDWIDTH = 4  #No of columns in the board
BOARDHEIGHT = 4 #No of rows in the board
TILESIZE = 80
WINDOWWIDTH = 640 
WINDOWHEIGHT = 480
FPS = 30
...
def main():
    ...
    SOLVEDBOARD = getStartingBoard() #A sloved board is same as the board in a start state.
        ...
        for event in pygame.event.get():
            ...
            if event.type == MOUSEBUTTONUP:
                ...
                if (spotx, spoty) == (None, None):
                    #Check if the user clicked on the option button.
...
def makeText(text, color, bgcolor, top, left):
    #Create the surface and rect objectsfor some text.
